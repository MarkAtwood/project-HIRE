...
impl TrustBundle {
    ...
    /// ever produce an ASN.1 parse error (hire-5s4b.60).
    ///
...
impl TrustBundleStore {
    ...
    /// That is hire-5s4b.37 and is deliberately not decided in this function:
...
mod tests {
    ...
    fn a_bundle_is_found_by_the_trust_domain_it_was_stored_under() {
        ...
        // the store's business. hire-grpc's ValidateJWTSVID used to spell
